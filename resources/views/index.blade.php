...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased bg-dark text-white d-flex flex-column justify-content-center align-items-center min-vh-100">
        <div class="container d-flex flex-row">
            ...
            <div class="col d-flex justify-content-center align-items-center">
                <div class="d-flex flex-column align-items-center w-75">
                    <a href="{{ asset('storage/images/none.png') }}" download class="w-100">
                        <img src="{{ asset('storage/images/none.png') }}" alt="Image" class="mx-auto my-auto d-block w-100" id="outFace">
                    </a>
        ...
        <script>
            ...
            event.preventDefault(); // Prevent form submission to allow script execution
            ...
            imgElement.src = "{{ asset('storage/images/generating.png') }}"; // Set the "generating" image immediately
            ...
            axios.post("{{ route('generate-image.generateFace') }}", formData)
                .then(response => {
                    const newImageUrl = response.data.imageUrl;
                    imgElement.src = newImageUrl; // Update the image URL when the response is received
                ...
                .catch(error => {
                    ...
                    imgElement.src = "{{ asset('storage/images/generatingerror.png') }}";
                    submitButton.textContent = 'Generate Face';
                    submitButton.disabled = false;
                });
            });
